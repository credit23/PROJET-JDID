...
void managerobotssubmenu(void) {
    ...
    while (1) {
        ...
        if (scanf("%d", &choice) != 1) {
            ...
            int c;
            while ((c = getchar()) != '\n' && c != EOF);
            printf("\033[31mInvalid input. Please enter a number 1-9.\033[0m\n");
            continue;
        }
        while (getchar() != '\n');
        ...
        switch (choice) {
            ...
            case 4: {
                ...
                if (scanf("%d", &id) == 1) {
                    ...
                    else printf("\033[31mRobot with ID %d not found!\033[0m\n", id);
                } else {
                    printf("\033[31mInvalid ID.\033[0m\n");
                    while (getchar() != '\n');
                }
            ...
            case 9:
                return;
            default:
                printf("\033[31mInvalid choice! Please select 1-9.\033[0m\n");
        }
    }
}
...
void managetaskssubmenu(void) {
    ...
    while (1) {
        ...
        if (scanf("%d", &choice) != 1) {
            int c;
            while ((c = getchar()) != '\n' && c != EOF);
            printf("\033[31mInvalid input. Please enter a number 1-7.\033[0m\n");
            continue;
        }
        while (getchar() != '\n');
        ...
        switch (choice) {
            ...
            case 4: {
                ...
                if (scanf("%d", &id) == 1) {
                    ...
                    else printf("\033[31mTask with ID %d not found!\033[0m\n", id);
                } else {
                    printf("\033[31mInvalid ID.\033[0m\n");
                    while (getchar() != '\n');
                }
            ...
            case 6: {
                ...
                if (scanf("%d", &stage) == 1) {
                    ...
                    printf("\033[31mInvalid stage.\033[0m\n");
                    while (getchar() != '\n');
                }
                break;
            }
            case 7:
                return;
            default:
                printf("\033[31mInvalid choice! Please select 1-7.\033[0m\n");
        }
    }
}
...
void controlQueueSubmenu(void) {
    ...
    while (1) {
        ...
        if (scanf("%d", &choice) != 1) {
            int c;
            while ((c = getchar()) != '\n' && c != EOF);
            printf("\033[31mInvalid input. Please enter a number 1-5.\033[0m\n");
            continue;
        }
        while (getchar() != '\n');
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                if (scanf("%d", &id) == 1) {
                    ...
                    Task *t = getTaskById(id);
                    if (t) enqueue(*t);
                    else printf("\033[31mTask %d not found!\033[0m\n", id);
                } else {
                    printf("\033[31mInvalid ID.\033[0m\n");
                    while (getchar() != '\n');
                }
            ...
            case 5:
                return;
            default:
                printf("\033[31mInvalid choice! Please select 1-5.\033[0m\n");
        }
    }
}